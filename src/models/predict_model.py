...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_name', type=str, default="proj_clip", help='Experiment name - default test')
    ...
    parser.add_argument('-t', '--temperature', type=float, default=1.0, help='https://velog.io/@clayryu328/paper-review-CLIP-Learning-Transferable-Visual-Models-From-Natural-Language-Supervision')
    ...
    # Testing model
    model_path = '/Users/philliphoejbjerg/Desktop/proj_clip/version_0/checkpoints/epoch=15-step=2384.ckpt'
