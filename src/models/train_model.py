...
if __name__ == "__main__":
    ...
    parser.add_argument('--margin', type=float, default=0.3, help='margin (for loss function) - default 0.5')
...
# CUDA_VISIBLE_DEVICES=0 python src/models/train_model.py --experiment_name triplet_linear_title --num_epochs 50 --loss_fn TripletLoss --num_workers 5 --head_name linear --text_mode "title"  --lr_scheduler --normalize --center_crop --batch_size 8